...
public class OrderSaveResponse {
    ...
    /** 주문 상품 */
    private List<OrderSaveResponse.OrderSaveItemResponse> items;

    public record OrderSaveItemResponse(
            // 주문 상품 아이디
            String id,
            // 제품 아이디
            Long productId,
    ...
    public static OrderSaveResponse of(final Order order) {
    ...
    private static List<OrderSaveResponse.OrderSaveItemResponse> convertOrderItems(Order order) {
        return order.getItems().stream()
                .map(o -> new OrderSaveResponse.OrderSaveItemResponse(
                        o.getId(),
                        o.getProductId(),
                        o.getPrice(),
                        o.getQuantity(),
